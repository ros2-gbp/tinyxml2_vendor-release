## tinyxml2_vendor (humble) - 0.7.7-1

The packages in the `tinyxml2_vendor` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble tinyxml2_vendor` on `Tue, 18 Nov 2025 10:10:48 -0000`
...
## tinyxml2_vendor (jazzy) - 0.9.2-1

The packages in the `tinyxml2_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy tinyxml2_vendor` on `Tue, 18 Nov 2025 10:05:04 -0000`
...
## tinyxml2_vendor (kilted) - 0.10.1-1

The packages in the `tinyxml2_vendor` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted tinyxml2_vendor` on `Tue, 18 Nov 2025 09:56:31 -0000`
...
## tinyxml2_vendor (rolling) - 0.11.3-1

The packages in the `tinyxml2_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling tinyxml2_vendor` on `Tue, 18 Nov 2025 09:52:12 -0000`
...
## tinyxml2_vendor (rolling) - 0.11.2-1

The packages in the `tinyxml2_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling tinyxml2_vendor` on `Tue, 29 Jul 2025 20:26:19 -0000`
...
## tinyxml2_vendor (rolling) - 0.11.1-1

The packages in the `tinyxml2_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling tinyxml2_vendor` on `Tue, 01 Jul 2025 14:28:56 -0000`
...
## tinyxml2_vendor (rolling) - 0.11.0-1

The packages in the `tinyxml2_vendor` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release tinyxml2_vendor -r rolling` on `Fri, 25 Apr 2025 20:40:00 -0000`
...
## tinyxml2_vendor (rolling) - 0.10.0-1

The packages in the `tinyxml2_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release tinyxml2_vendor --rosdistro rolling --non-interactive` on `Mon, 29 Apr 2024 08:28:45 -0000`
